 ...
 */
@WebServlet("/RechercherGroupeServlet")
public class RechercherGroupeServlet extends HttpServlet {
     ...
     */
    public RechercherGroupeServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		if( request.getSession().getAttribute("loggedUser")==null ) response.sendRedirect("InscriptionServlet?code=-1");
			...
			request.getRequestDispatcher("Administrateur/rechercherGroupe.jsp?code="+request.getParameter("code")).forward(request, response);
		}
	}
