 ...
 */
@WebServlet("/RechercherCategorieServlet")
public class RechercherCategorieServlet extends HttpServlet {
     ...
     */
    public RechercherCategorieServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		if( request.getSession().getAttribute("loggedUser")==null ) response.sendRedirect("InscriptionServlet?code=-1");
			...
			request.getRequestDispatcher("Administrateur/rechercherCategorie.jsp?code="+request.getParameter("code")).forward(request, response);
		}
	}
