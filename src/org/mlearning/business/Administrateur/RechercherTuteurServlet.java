 ...
 */
@WebServlet("/RechercherTuteurServlet")
public class RechercherTuteurServlet extends HttpServlet {
     ...
     */
    public RechercherTuteurServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		if( request.getSession().getAttribute("loggedUser")==null ) response.sendRedirect("InscriptionServlet?code=-1");
			...
			request.getRequestDispatcher("Administrateur/rechercherTuteur.jsp?code="+request.getParameter("code")).forward(request, response);
		}
	}
