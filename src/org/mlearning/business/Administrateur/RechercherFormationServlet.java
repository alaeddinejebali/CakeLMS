 ...
 */
@WebServlet("/RechercherFormationServlet")
public class RechercherFormationServlet extends HttpServlet {
     ...
     */
    public RechercherFormationServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		if( request.getSession().getAttribute("loggedUser")==null ) response.sendRedirect("InscriptionServlet?code=-1");
			...
			request.getRequestDispatcher("Administrateur/rechercherFormation.jsp?code="+request.getParameter("code")).forward(request, response);
		}
	}
