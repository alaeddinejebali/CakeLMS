 ...
 */
@WebServlet("/RechercherApprenantServlet")
public class RechercherApprenantServlet extends HttpServlet {
     ...
     */
    public RechercherApprenantServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		if( request.getSession().getAttribute("loggedUser")==null ) response.sendRedirect("InscriptionServlet?code=-1");
			...
			request.getRequestDispatcher("Administrateur/rechercherApprenant.jsp?code="+request.getParameter("code")).forward(request, response);
		}
	}
