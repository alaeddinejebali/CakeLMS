...
/**
 * Servlet implementation class Sallediscussionplay
 */
@WebServlet("/Sallediscussionplay")
public class Sallediscussionplay extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		if( request.getSession().getAttribute("loggedUser")==null ) response.sendRedirect("InscriptionServlet?code=-1");
			...
			request.getRequestDispatcher("Tuteur/sallediscussionplay.jsp").forward(request, response);
		}
	}
