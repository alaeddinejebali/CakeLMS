...
/**
 * Servlet implementation class AjouterRessourceCoursText
 */
@WebServlet("/AjouterRessourceCoursText")
public class AjouterRessourceCoursText extends HttpServlet {
     ...
     */
    public AjouterRessourceCoursText() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		request.getRequestDispatcher("Tuteur/ajouterRessourceCoursText.jsp").forward(request, response);
	}
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String titre="", description="", excerpt="", contenu="";
		int tempsRequis = 0;
		//DATE DE NAISSANCE
