...
/**
 * Servlet implementation class AjouterRessourceCoursAudio
 */
@WebServlet("/AjouterRessourceCoursAudio")
public class AjouterRessourceCoursAudio extends HttpServlet {
     ...
     */
    public AjouterRessourceCoursAudio() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		request.getRequestDispatcher("Tuteur/ajouterRessourceCoursAudio.jsp").forward(request, response);
	}
