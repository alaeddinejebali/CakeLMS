...
**/
	...
	createPicker: function() {
		...
		row.appendChild(this.createCell(this.hours, 12,
			0));
		...
		if (!this.options.use24hrs) {
			...
			this.am = new Element('div', {'class': '_pp_timepicker_ampm _pp_highlight'}).update('');
			...
			this.pm = new Element('div', {'class': '_pp_timepicker_ampm'}).update('');
