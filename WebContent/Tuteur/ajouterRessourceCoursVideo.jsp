		...
		<div class="rightpanel">
			...
			<div class="pagetitle">
				...
				<div class="maincontent">
					...
					<!-- AJOUT FORM -->					
					<h2 align="center" class="d_title">Créer une ressource video</h2><hr/>
					<form action="AjouterRessourceCoursVideo" method="POST" class="stdform" id="ajouterRessourceCoursTextForm" novalidate="novalidate" enctype="multipart/form-data">
						<div class="par control-group">
							<label for="titre" class="control-label">Titre</label>
							<div class="controls"><input type="text" class="input-xxlarge" id="titre" name="titre"></div>
						</div>
						<div class="par control-group">
							<label for="url" class="control-label">Source video</label>
							<div class="controls">
                            	...
                            	<select id="url" name="url" data-placeholder="Choisir une ressource..." class="chzn-select listWithSearch" tabindex="2">
									<option value=""></option>
									<script type="text/javascript" src="assets/webServices/appels/getRessourcesVideo.js"></script>
								</select>	 
						...
						<p class="stdformbutton">
							<button class="btn btn-primary btn-rounded">Ajouter ressource video</button>
						</p>
					</form>
				</div>
			</div>	
