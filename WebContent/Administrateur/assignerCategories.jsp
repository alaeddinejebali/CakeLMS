	...
	<div class="mainwrapper">
		...
		<div class="rightpanel">
    		<jsp:include page="../assets/layout/common/top.jsp"></jsp:include>
				...
				<div class="pagetitle">
					<h1>ASSIGNER CAT&Eacute;GORIES</h1> <span>Administration de la plateforme...</span>
				</div>

				<div class="maincontent">
					<div id="admin_affecterCategories">
						<h2 align="center" class="d_title">Assignement catégories au formation</h2><hr/>
						<form action="AssignerCategoriesServlet" method="POST" class="formWithDualSelect" id="affecterCategoriesForm" novalidate="novalidate">
	                        ...
	                        <p class="control-group">
	                        	<label>Choisir la (les) liste(s) des catégorie(s)</label>
	                            ...
	                            <input type="text" name="categories" id="hiddenDualSelect" />
	                        </p>
	                        <br/>
