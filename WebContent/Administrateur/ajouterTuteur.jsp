...
<link rel="stylesheet" type="text/css" href="css/administrateur.css" />
	<div class="mainwrapper">
		...
		<div class="rightpanel">
			...
			<div class="pagetitle">
				<h1>NOUVEAU TUTEUR</h1> <span>Administration de la plateforme...</span>
			</div>

				<div class="maincontent">
					<h2 align="center" class="d_title">Ajouter tuteur</h2><hr/>
					<form action="AjouterTuteurServlet" method="POST" class="stdform" id="ajouterApprenantForm" novalidate="novalidate" enctype="multipart/form-data">
						...
						<p class="stdformbutton">
							<button class="btn btn-primary btn-rounded">Ajouter tuteur</button>
						</p>
					</form>
				</div>
			</div>	
