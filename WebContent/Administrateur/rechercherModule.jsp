	...
	<div class="mainwrapper">
		...
		<div class="rightpanel">
    		<jsp:include page="../assets/layout/common/top.jsp"></jsp:include>
				...
				<div class="pagetitle">
					<h1>RECHERCHER MODULES</h1> <span>Administration de la plateforme...</span>
				</div>

				<div class="maincontent">
					<div id="admin_accueil_listeDesFormation">
		            	<h2 align="center" class="d_title">Rechercher modules</h2><hr/>
							...
							<tbody>
								...
								<tr class="gradeX">
									<td class="aligncenter"><span class="center">
										<a href="ModuleServlet?module=<%= oneModule.getId() %>"><img src="images/img/see.png" /></a>
									</span></td>
									<td><%= oneModule.getNom() %></td>
									<td><%= oneModule.getDescription() %></td>
								</tr>
								<%
									}
								%> 
