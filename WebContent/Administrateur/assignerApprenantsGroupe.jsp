    		...
    		<jsp:include page="../assets/layout/common/top.jsp"></jsp:include>
				...
				<div class="maincontent">
					<div id="admin_affecterCategories">
						<h2 align="center" class="d_title">Assignement des apprenants au Groupe</h2><hr/>
						<form action="AssignerApprenantsGroupeServlet" method="POST" class="formWithDualSelect" id="assignerApprenantsGroupeForm" novalidate="novalidate">
							<p class="control-group">
								<label>Choisir un groupe</label>
								<span class="formwrapper">
									<select data-placeholder="" style="width:100%" class="chzn-select" tabindex="2" name="groupe" id="groupe">
										<%
